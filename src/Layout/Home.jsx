...
const Home = () => {
    return (
        <div className='p-4  flex my-container flex-col-reverse lg:flex-row items-center justify-between pt-8'>
            ...
            <Lottie className='' animationData={groovyWalkAnimation} loop={true} />
        </div>
    );
};
